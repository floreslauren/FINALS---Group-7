...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"insert into tblappointment(AptNumber,Name,Email,PhoneNumber,AptDate,AptTime,Services,reference
    ) value('$aptnumber','$name','$email','$phone','$adate','$atime','$services','$reference')");
    if ($query) {
...
<head>
    ...
    <title>Pepit's Barbershop System || Appointments Form</title>
    <!-- Bootstrap -->
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p> Book your appointment to save time.</p>
                            <form method="post">
                                <div class="row">
                                    <div class="col-md-6">
              ...
              ?>
                               ...
                               <?php } ?> 
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label" for="textarea">Take note for every reservations need a 10% downpayment. Thank you!</label><br>
                                            <img src="images/qr.jpg" alt="qr" width="300" height="400"><br>
                                            <label class="control-label" for="textarea">You can type the number 09123456789</label><br>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="control-label" for="reference">Referrence Number</label>
                                         <input type="text" class="form-control" id="appointment_referrence" placeholder="Referrence" name="reference" required="true">
                                    </div>
